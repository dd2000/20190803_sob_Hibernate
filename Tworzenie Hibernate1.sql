-- wcześniej utworzyć nowy schemat (DB) KSIEGARNIA
-- wybrać po lewej/dół zakładkę Administration i dodać użutkownika  (Users and privileges) user sdatest pass: (opis na slacku
-- użytkownikowi sdatest nadać wszystkie uprawnienia 


-- uruchomić ten skrypt - pierwsze dwie linie ustawiają strefę czasową
